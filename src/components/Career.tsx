        ...
        <div className="career-info">
          ...
          <div className="career-info-box">
            <div className="career-info-in">
              ...
              <h3>May 2020 — May 2024</h3>
            </div>
            <p>
              Graduated with a Bachelor of Engineering in Information Technology with a GPA of 8.90/10. Coursework included Operating Systems, Computer Networks, Database Systems, and Software Engineering.
            </p>
          </div>
        </div>
      </div>
